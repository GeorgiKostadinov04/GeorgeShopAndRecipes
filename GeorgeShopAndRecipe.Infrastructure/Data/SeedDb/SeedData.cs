...
namespace GeorgeShopAndRecipe.Infrastructure.Data.SeedDb
{
    ...
    {
        private Category FirstCategory { get; set; }

        private Category SecondCategory {  get; set; }

        private Category ThirdCategory { get; set; }

        private Category FourthCategory { get; set; }

        private Category FifthCategory { get; set; }

        private Category NoneCategory { get; set; }

        private Recipe FirstRecipe { get; set; }

        private Recipe SecondRecipe { get; set;}

        private Shop FirstShop { get; set; }

        private Ingredient FirstIngredient { get; set; }

        private Ingredient SecondIngredient { get; set; }

        private Ingredient ThirdIngredient { get; set; }

        private Ingredient FourthIngredient { get;set; }

        private Ingredient FifthIngredient { get; set; }

        private Supplier FirstSupplier { get; set; }

        private IdentityUser RecipeDeveloperUser { get; set; }

        private IdentityUser GuestUser { get; set; }

        private RecipeDeveloper RecipeDeveloper { get; set; }
        ...
        private void SeedShops()
        {
            FirstShop = new Shop()
            {
                ...
                Suppliers = new List<Supplier>()
                {
                    ...
                    {
                        Id = FirstSupplier.Id,
                        FirstName = FirstSupplier.FirstName,
                        LastName = FirstSupplier.LastName,
                        Rating = FirstSupplier.Rating,
                        Age = FirstSupplier.Age,
                    }
                },
                Ingredients = new List<Ingredient>()
                {
                    new Ingredient()
                    {
                        ...
                        PricePerUnit = FirstIngredient.PricePerUnit,
                        ExpireDate = FirstIngredient.ExpireDate,
